...
<head>
    ...
    <title>Successfully Registered | Leaf Cafe</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container form-signin text-center reg-success mt-auto">
            ...
            <p class="mb-3 fw-normal text-bold">Welcome and enjoy your food with Sai Cafe</p>
  ...
  <div class="text-center p-2 p-2 mb-1 bg-dark text-white">
    <p class="text-white">© 2022 Copyright : Patel Group</p>
